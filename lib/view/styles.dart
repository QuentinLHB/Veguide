...
TextStyle styleH1 = const TextStyle(fontSize: 26, fontFamily: 'SweetyRasty');
TextStyle styleH2 = TextStyle(fontSize: 20, color: deepGreen, fontWeight: FontWeight.bold);
...
Color black = Colors.black.withOpacity(0.5);
